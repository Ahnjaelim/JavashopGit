...
public class SampleRestController {
	...
	@GetMapping(value = "/api02", produces = MediaType.APPLICATION_JSON_VALUE)
	public String weatherapi() throws Exception {
		...
		urlBuilder.append("&" + URLEncoder.encode("base_date","UTF-8") + "=" + URLEncoder.encode("20230301", "UTF-8")); /*‘21년 6월 28일 발표*/
